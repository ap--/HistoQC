function load_raw_data () {
	...
	fileReader.onload = function () {
		...
		load_from_text(fileReader.result);
	}
}

/**
 * Load results from a path relative to the /Data dir
 * @param {string} urlpath - Path to the results.tsv, i.e. 'something/results.tsv'
 */
function load_from_ui(urlpath) {
	$.get("/Data/" + urlpath, load_from_text, "text");
}

/**
 * Load results and init the UI
 * @param {string} file_text - The content of a results.tsv file
 */
function load_from_text(file_text) {
